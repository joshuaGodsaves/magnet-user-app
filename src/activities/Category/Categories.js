...
import {
  Add, Refresh, FormatAlignRight, Filter, MoreHoriz, Delete, Edit, Collections as Group
              ...
              <TableBody>
                {this.state.categories.map((v, i) => (
                    <TableRow>
                      ...
                      <TableCell><IconButton component={Link} to={`/categories/${v._id}`}><MoreHoriz/></IconButton></TableCell>
                    </TableRow>
                ))}
              </TableBody>
            </Table>
